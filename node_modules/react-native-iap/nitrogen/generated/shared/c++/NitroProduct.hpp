...
namespace margelo::nitro::iap {
  ...
  public:
    ...
    std::optional<std::string> subscriptionOffers     SWIFT_PRIVATE;
    std::optional<std::string> discountOffers     SWIFT_PRIVATE;
  ...
  struct JSIConverter<margelo::nitro::iap::NitroProduct> final {
    static inline margelo::nitro::iap::NitroProduct fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return margelo::nitro::iap::NitroProduct(
        ...
        JSIConverter<std::optional<std::string>>::fromJSI(runtime, obj.getProperty(runtime, "subscriptionOffers")),
        JSIConverter<std::optional<std::string>>::fromJSI(runtime, obj.getProperty(runtime, "discountOffers")),
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::iap::NitroProduct& arg) {
      ...
      obj.setProperty(runtime, "subscriptionOffers", JSIConverter<std::optional<std::string>>::toJSI(runtime, arg.subscriptionOffers));
      obj.setProperty(runtime, "discountOffers", JSIConverter<std::optional<std::string>>::toJSI(runtime, arg.discountOffers));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<std::string>>::canConvert(runtime, obj.getProperty(runtime, "subscriptionOffers"))) return false;
      if (!JSIConverter<std::optional<std::string>>::canConvert(runtime, obj.getProperty(runtime, "discountOffers"))) return false;
