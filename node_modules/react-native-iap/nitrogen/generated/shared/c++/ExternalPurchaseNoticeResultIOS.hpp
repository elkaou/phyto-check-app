...
namespace margelo::nitro::iap {
  ...
  public:
    ...
    std::optional<std::string> externalPurchaseToken     SWIFT_PRIVATE;
    ExternalPurchaseNoticeAction result     SWIFT_PRIVATE;

  public:
    ExternalPurchaseNoticeResultIOS() = default;
    explicit ExternalPurchaseNoticeResultIOS(std::optional<std::string> error, std::optional<std::string> externalPurchaseToken, ExternalPurchaseNoticeAction result): error(error), externalPurchaseToken(externalPurchaseToken), result(result) {}
  };
  ...
  struct JSIConverter<margelo::nitro::iap::ExternalPurchaseNoticeResultIOS> final {
    static inline margelo::nitro::iap::ExternalPurchaseNoticeResultIOS fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return margelo::nitro::iap::ExternalPurchaseNoticeResultIOS(
        ...
        JSIConverter<std::optional<std::string>>::fromJSI(runtime, obj.getProperty(runtime, "externalPurchaseToken")),
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::iap::ExternalPurchaseNoticeResultIOS& arg) {
      ...
      obj.setProperty(runtime, "externalPurchaseToken", JSIConverter<std::optional<std::string>>::toJSI(runtime, arg.externalPurchaseToken));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<std::string>>::canConvert(runtime, obj.getProperty(runtime, "externalPurchaseToken"))) return false;
